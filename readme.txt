...
If you ever need help (though you probably won’t :) ), feel free to reach out:
...
Just **double-click the `.exe` file** — and you're good to go!

---

## ✨ Features

✅ **Start/Stop Automation with Hotkeys**  
...
This behavior is common in automation tools and does not indicate a virus — especially if you built it yourself or downloaded it from my trusted GitHub.
